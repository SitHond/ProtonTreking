...
- позволяет выбрать режим запуска и задержку перед стартом трейнера.
...
7. Даёт переключать режим запуска (`runinprefix start /unix`, `runinprefix`, `run`) и задавать задержку старта.
